      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <ContactCard
              title="Email"
              data="santhosh.sivkumar@gmail.com"
              link="mailto:santhosh.sivkumar@gmail.com"
              iconClass="bx bx-mail-send contact__card-icon"
            />
            <ContactCard
              title="Whatsapp"
              data="+919363738303"
              link="https://api.whatsapp.com/send?phone=919363738303&text=Hello, Santhosh!"
              iconClass="bx bxl-whatsapp contact__card-icon"
            />
            <ContactCard
              title="Messenger"
              data="santhosh.sivakumar"
